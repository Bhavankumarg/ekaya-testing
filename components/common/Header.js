      ...
      <nav class="bg-transparent bg-opacity-5 absolute w-full z-50 top-0 start-0 border-b border-[#f8fafc7a]">
        <div class="flex justify-between p-4 lg:w-[80%] mx-auto  items-center z-50 ">
          ...
          >
            <button
              type="button"
              class="text-black bg-white hover:bg-black hover:text-white poppins-normal rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              INQUIRE
              <svg
            ...
            <div class="py-12 overflow-y-auto">
              <ul class="space-y-2 font-medium">
                <li>
                  <button
                    type="button"
                    class="flex items-center poppins-light w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-ongoing"
                    data-collapse-toggle="dropdown-ongoing"
                  >
                  ...
                  <ul id="dropdown-ongoing" class="hidden py-2 space-y-2">
                    <li>
                      <Link
                        href="/about-dona-paula"
                        onClick={handleClick}
                        class="flex poppins-light items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group bg-e-green dark:text-white dark:hover:bg-gray-700"
                      >
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                          Goa - Dona Paula
                        </span>
                      ...
                      <ul class="py-2 space-y-2">
                        <li>
                          <Link
                            href="/vista-do-mar"
                            onClick={handleClick}
                            class="flex items-center poppins-light w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                          >
                            — Vista Do Mar
                          </Link>
                        </li>
                      ...
                      <button
                        type="button"
                        class="flex items-center poppins-light w-full p-2 text-base text-white bg-e-green transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      >
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                          Bangalore
                        </span>
                ...
                <li>
                  <button
                    type="button"
                    class="flex items-center w-full p-2 poppins-light text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-completed"
                    data-collapse-toggle="dropdown-completed"
                  >
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                      Completed Projects
                    </span>
                  ...
                  <ul id="dropdown-completed" class="hidden py-2 space-y-2">
                    <li>
                      <button
                        type="button"
                        class="flex poppins-light items-center w-full p-2 text-base text-white bg-e-green transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      >
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                          Bangalore
                        </span>
                ...
                <li>
                  <button
                    type="button"
                    class="flex items-center poppins-light w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-upcoming"
                    data-collapse-toggle="dropdown-upcoming"
                  >
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                      Upcoming Projects
                    </span>
                  ...
                  <ul id="dropdown-upcoming" class="hidden py-2 space-y-2">
                    <li>
                      <button
                        type="button"
                        class="flex items-center w-full p-2 text-base poppins-light text-white transition duration-75 rounded-lg group bg-e-green dark:text-white dark:hover:bg-gray-700"
                      >
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                          Goa — Moira
                        </span>
                ...
                <li>
                  <button
                    ...
                    data-collapse-toggle="dropdown-about"
                  >
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                      About Ekaya
                    </span>
